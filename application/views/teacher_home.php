    ...
    <div class='page'>
            <div class="navigation expanded" id="navigation">
                ...
                <div class="navigation__inner">
                    <ul>
                        <li>
                            <h2>Assessment Menu</h2>
                        </li>
<!--                        <li><a class="current" href="#">Add Assessment</a></li>-->
                        <li onclick="return AddAssessment();"><a href="#main_teacher">Add</a></li>
                        <li onclick="return EditAssessment();"><a href="#main_teacher">Edit</a></li>
                        <li onclick="return DeleteAssessment();"><a href="#main_teacher">Delete</a></li>
                        <li ><a href="<?php echo base_url();?>DataEntry/ViewStudents">View Student</a></li>
                        <li onclick="return ChangePassword();"><a href="#main_teacher">Password</a></li>
